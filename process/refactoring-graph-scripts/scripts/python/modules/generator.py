...
def save_graph_to_html(language, config_graphviz):
  path = '../../../../data/dataset/graphviz/{}'.format(config_graphviz.get('project'))
...
def find_disconnected_subgraphs():
  ...
  for project_name in datasetconfig.get_java_projects():
    ...
    #Save results
    util.write_json(groups_subgraph.get('subgraphs_same_commit'), '../../../../data/dataset/graphs/', 'atomic_subgraphs_{}.json'.format(util.get_name_project_formated(project_name)))
    util.write_json(groups_subgraph.get('subgraphs_different_commit'), '../../../../data/dataset/graphs/', 'overtime_subgraphs_{}.json'.format(util.get_name_project_formated(project_name)))
...
def create_views():
  ...
  for project_name in datasetconfig.get_java_projects():
    #over time graphs
    json_graphs_different_commit = '../../../../data/dataset/graphs/overtime_subgraphs_{}.json'.format(util.get_name_project_formated(project_name))
    ...
    #atomic graphs
    json_graphs_same_commit = '../../../../data/dataset/graphs/atomic_subgraphs_{}.json'.format(util.get_name_project_formated(project_name))
