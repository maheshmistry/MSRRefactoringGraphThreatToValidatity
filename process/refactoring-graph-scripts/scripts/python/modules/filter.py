...
def filter_core_elements():
  ...
  for project_name in datasetconfig.get_java_projects():
    commits_file = '../../../../data/dataset/commits/commits_{}.csv'.format(util.get_name_project_formated(project_name))
    refactorings_file = '../../../../data/dataset/refactorings/refactorings_{}.csv'.format(util.get_name_project_formated(project_name))
